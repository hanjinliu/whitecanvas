...
def test_cat(backend: str):
    ...
    canvas.cat(df, "x", "y").along_x().add_hist_line(bins=5)
    canvas.cat(df, "x", "y").along_x().add_hist_line(bins=5, color="label")
    canvas.cat(df, "x", "y").along_y().add_hist_line(bins=6)
    canvas.cat(df, "x", "y").along_y().add_hist_line(bins=6, color="label")
